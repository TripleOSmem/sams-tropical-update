...
public class RiverDolphinEntityModel<T extends Entity> extends SinglePartEntityModel<T> {
    private final ModelPart root;
    private final ModelPart body;
    private final ModelPart tail;
    private final ModelPart tailFin;

    public RiverDolphinEntityModel(ModelPart root) {
        this.root = root;
    ...
    public RiverDolphinEntityModel(ModelPart root, ModelPart body, ModelPart tail, ModelPart tailFin) {
        this.root = root;
        this.body = body;
        this.tail = tail;
